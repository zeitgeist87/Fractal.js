...
var Fractal = (function(Fractal, Color) {
	...
	// constructor
	function Pythagoras(canvas, maxorder, pos, startcolor, stopcolor, alpha) {
		if (!(this instanceof Pythagoras))
			return new Pythagoras(canvas, maxorder, pos, startcolor, stopcolor,
					alpha);
	...
	Pythagoras.prototype = {
		...
		draw : function(curr_order, width) {
			var ctx = this.ctx,
